...
def count_unique_words(str):
    s=set([i.lower() for i in str.split() if i.isalpha()]) # Find unique words in case-insensitive manner
    return len(s)
print("The number of unique words in the text:",count_unique_words(s))